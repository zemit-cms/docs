...
* Full name: `\Zemit\Models\AuditDetail`
* Parent class: [`\Zemit\Models\Abstracts\AuditDetailAbstract`](./Abstracts/AuditDetailAbstract.md)
* This class implements:
[`\Zemit\Models\Interfaces\AuditDetailInterface`](./Interfaces/AuditDetailInterface.md)
...
```php
public setEvent(mixed $event): void
```
...
```php
public setBefore(mixed $before): void
```
...
```php
public setAfter(mixed $after): void
```
