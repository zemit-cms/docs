...
* Full name: `\Zemit\Models\RoleRole`
* Parent class: [`\Zemit\Models\Abstracts\RoleRoleAbstract`](./Abstracts/RoleRoleAbstract.md)
* This class implements:
[`\Zemit\Models\Interfaces\RoleRoleInterface`](./Interfaces/RoleRoleInterface.md)
...
```php
public setChildId(mixed $childId): void
```
