...
* Full name: `\Zemit\Models\Oauth2`
* Parent class: [`\Zemit\Models\Abstracts\Oauth2Abstract`](./Abstracts/Oauth2Abstract.md)
* This class implements:
[`\Zemit\Models\Interfaces\Oauth2Interface`](./Interfaces/Oauth2Interface.md)
...
```php
public setProvider(mixed $provider): void
```
...
```php
public setProviderUuid(mixed $providerUuid): void
```
...
```php
public setFirstName(mixed $firstName): void
```
...
```php
public setLastName(mixed $lastName): void
```
