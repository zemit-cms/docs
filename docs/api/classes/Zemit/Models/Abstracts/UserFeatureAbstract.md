...
Class UserFeatureAbstract

This class defines a UserFeature abstract model that extends the AbstractModel class and implements the UserFeatureAbstractInterface.
It provides properties and methods for managing UserFeature data.

* Full name: `\Zemit\Models\Abstracts\UserFeatureAbstract`
* Parent class: [`\Zemit\Models\AbstractModel`](../AbstractModel.md)
* This class implements:
[`\Zemit\Models\Abstracts\Interfaces\UserFeatureAbstractInterface`](./Interfaces/UserFeatureAbstractInterface.md)
...
```php
public setFeatureId(mixed $featureId): void
```
