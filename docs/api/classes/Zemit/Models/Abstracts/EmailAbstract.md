...
* Full name: `\Zemit\Models\Abstracts\EmailAbstract`
* Parent class: [`\Zemit\Models\AbstractModel`](../AbstractModel.md)
* This class implements:
[`\Zemit\Models\Abstracts\Interfaces\EmailAbstractInterface`](./Interfaces/EmailAbstractInterface.md)
...
```php
public setTemplateId(mixed $templateId): void
```
...
```php
public setFrom(mixed $from): void
```
...
```php
public setReadReceiptTo(mixed $readReceiptTo): void
```
...
```php
public setMeta(mixed $meta): void
```
...
```php
public setViewPath(mixed $viewPath): void
```
...
```php
public setSent(mixed $sent): void
```
...
```php
public setSentAt(mixed $sentAt): void
```
...
```php
public setSentBy(mixed $sentBy): void
```
...
```php
public setSentAs(mixed $sentAs): void
```
