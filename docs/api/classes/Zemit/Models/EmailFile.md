...
* Full name: `\Zemit\Models\EmailFile`
* Parent class: [`\Zemit\Models\Abstracts\EmailFileAbstract`](./Abstracts/EmailFileAbstract.md)
* This class implements:
[`\Zemit\Models\Interfaces\EmailFileInterface`](./Interfaces/EmailFileInterface.md)
...
```php
public setEmailId(mixed $emailId): void
```
