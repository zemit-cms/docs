...
* Full name: `\Zemit\Models\Audit`
* Parent class: [`\Zemit\Models\Abstracts\AuditAbstract`](./Abstracts/AuditAbstract.md)
* This class implements:
[`\Zemit\Models\Interfaces\AuditInterface`](./Interfaces/AuditInterface.md)
...
```php
public setColumns(mixed $columns): void
```
