...
* Full name: `\Zemit\Models\Interfaces\JobInterface`
* Parent interfaces: [`\Zemit\Models\Abstracts\Interfaces\JobAbstractInterface`](../Abstracts/Interfaces/JobAbstractInterface.md)
...
```php
public setThread(mixed $thread): void
```
...
```php
public setPriority(mixed $priority): void
```
