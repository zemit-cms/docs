...
* Full name: `\Zemit\Models\Translate`
* Parent class: [`\Zemit\Models\Abstracts\TranslateAbstract`](./Abstracts/TranslateAbstract.md)
* This class implements:
[`\Zemit\Models\Interfaces\TranslateInterface`](./Interfaces/TranslateInterface.md)
...
```php
public setPageId(mixed $pageId): void
```
...
```php
public setPostId(mixed $postId): void
```
...
```php
public setCategoryId(mixed $categoryId): void
```
