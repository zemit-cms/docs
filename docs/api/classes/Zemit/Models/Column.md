...
* Full name: `\Zemit\Models\Column`
* Parent class: [`\Zemit\Models\Abstracts\ColumnAbstract`](./Abstracts/ColumnAbstract.md)
* This class implements:
[`\Zemit\Models\Interfaces\ColumnInterface`](./Interfaces/ColumnInterface.md)
...
```php
public getValidationRegex(): mixed
```
...
```php
public setValidationRegex(mixed $validationRegex): void
```
