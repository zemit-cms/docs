...
* Full name: `\Zemit\Models\Log`
* Parent class: [`\Zemit\Models\Abstracts\LogAbstract`](./Abstracts/LogAbstract.md)
* This class implements:
[`\Zemit\Models\Interfaces\LogInterface`](./Interfaces/LogInterface.md)
