...
* Full name: `\Zemit\Models\Job`
* Parent class: [`\Zemit\Models\Abstracts\JobAbstract`](./Abstracts/JobAbstract.md)
* This class implements:
[`\Zemit\Models\Interfaces\JobInterface`](./Interfaces/JobInterface.md)
