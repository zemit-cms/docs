...
* Full name: `\Zemit\Models\Session`
* Parent class: [`\Zemit\Models\Abstracts\SessionAbstract`](./Abstracts/SessionAbstract.md)
* This class implements:
[`\Zemit\Models\Interfaces\SessionInterface`](./Interfaces/SessionInterface.md)
...
```php
public setToken(mixed $token): void
```
...
```php
public setDate(mixed $date): void
```
