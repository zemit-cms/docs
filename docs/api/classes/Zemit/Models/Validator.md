...
* Full name: `\Zemit\Models\Validator`
* Parent class: [`\Zemit\Models\Abstracts\ValidatorAbstract`](./Abstracts/ValidatorAbstract.md)
* This class implements:
[`\Zemit\Models\Interfaces\ValidatorInterface`](./Interfaces/ValidatorInterface.md)
...
```php
public setFieldId(mixed $fieldId): void
```
