...
* Full name: `\Zemit\Mvc\ModelInterface`
* Parent interfaces: [`\Zemit\Mvc\Model\Interfaces\AttributeInterface`](./Model/Interfaces/AttributeInterface.md), [`\Zemit\Mvc\Model\Interfaces\BehaviorInterface`](./Model/Interfaces/BehaviorInterface.md), [`\Zemit\Mvc\Model\Interfaces\BlameableInterface`](./Model/Interfaces/BlameableInterface.md), [`\Zemit\Mvc\Model\Interfaces\EagerLoadInterface`](./Model/Interfaces/EagerLoadInterface.md), [`\Zemit\Mvc\Model\Interfaces\ExposeInterface`](./Model/Interfaces/ExposeInterface.md), [`\Zemit\Mvc\Model\Interfaces\HashInterface`](./Model/Interfaces/HashInterface.md), [`\Zemit\Mvc\Model\Interfaces\IdentityInterface`](./Model/Interfaces/IdentityInterface.md), [`\Zemit\Mvc\Model\Interfaces\JsonInterface`](./Model/Interfaces/JsonInterface.md), [`\Zemit\Mvc\Model\Interfaces\LocaleInterface`](./Model/Interfaces/LocaleInterface.md), [`\Zemit\Mvc\Model\Interfaces\MetaDataInterface`](./Model/Interfaces/MetaDataInterface.md), [`\Zemit\Mvc\Model\Interfaces\OptionsInterface`](./Model/Interfaces/OptionsInterface.md), [`\Zemit\Mvc\Model\Interfaces\PositionInterface`](./Model/Interfaces/PositionInterface.md), [`\Zemit\Mvc\Model\Interfaces\RelationshipInterface`](./Model/Interfaces/RelationshipInterface.md), [`\Zemit\Mvc\Model\Interfaces\ReplicationInterface`](./Model/Interfaces/ReplicationInterface.md), [`\Zemit\Mvc\Model\Interfaces\SecurityInterface`](./Model/Interfaces/SecurityInterface.md), [`\Zemit\Mvc\Model\Interfaces\SlugInterface`](./Model/Interfaces/SlugInterface.md), [`\Zemit\Mvc\Model\Interfaces\SnapshotInterface`](./Model/Interfaces/SnapshotInterface.md), [`\Zemit\Mvc\Model\Interfaces\SoftDeleteInterface`](./Model/Interfaces/SoftDeleteInterface.md), [`\Zemit\Mvc\Model\Interfaces\ValidateInterface`](./Model/Interfaces/ValidateInterface.md), [`ModelInterface`](https://docs.phalcon.io/latest/api/){:target="_blank"}
